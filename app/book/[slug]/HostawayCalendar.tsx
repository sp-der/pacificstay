  ...
  return (
    <div className={styles.hostawayCard}>
      ...
      <p className={styles.hostawayIntro}>
        Live availability and checkout for {propertyName}. Select available dates below, then continue to the secure booking flow.
      </p>
      ...
      <div className={styles.hostawaySecurity}>
        <ShieldCheck size={16} />
        <span>Availability, rates, taxes, fees, and checkout are provided by Pacific Stay&apos;s Hostaway booking system.</span>
      </div>
